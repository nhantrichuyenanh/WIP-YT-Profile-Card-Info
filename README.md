...
- Because helpful information is hidden in Profile Card, which is practically useless (user must manually click profile picture to access it, and barely anyone does that), this add-on makes it accessible at the user's fingertips.
